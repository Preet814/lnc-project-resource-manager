...
DEFAULT_TIMESHEET_REMINDER_CRON = "0 9 * * mon,tue,wed"
DEFAULT_TIMESHEET_FREEZE_CRON = "30 17 * * tue"
DEFAULT_TIMESHEET_WEDNESDAY_CRON = "0 9 * * wed"
TIMESHEET_FREEZE_HOUR = 17
